...
<body>
    ...
    <section>
        <div class="title-on-page">
            <h1>Tentang Kami</h1>
            <p class="desc-index">
                CV. Rejeki Agung bergerak di bidang produksi dan distribusi timbangan
                elektronik serta mekanik. Kami memiliki tenaga ahli untuk mendukung
                layanan purna jual kami. Kami menyediakan solusi untuk kebutuhan
                penimbangan di semua lini usaha dengan produk berkualitas yang
                dilengkapi garansi selama 12 bulan. Bermitra dengan kami berarti
                memilih mitra yang terpercaya, jujur, dan amanah.
            </p>
        </div>
    </section>
    <br />
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-6 col-lg-4 d-flex justify-content-center mb-4">
                <div class="card rounded-img shadow-card" style="width: 20rem">
                    <img src="images/mine_2.webp" class="card-img-top rounded-img" alt="BenchScale" />
                    <div class="card-body">
                        <h5 class="card-title">Plantation and Mining</h5>
                        <p></p>
                        <div class="btn-center">
                            <button type="button" class="btn btn-primary custom-btn">
                                <a href="Plantation_and_Mining">Selengkapnya</a>
                            </button>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12 col-md-6 col-lg-4 d-flex justify-content-center mb-4">
                <div class="card rounded-img shadow-card" style="width: 20rem">
                    <img src="images/warehouse.webp" class="card-img-top rounded-img" alt="BenchScale" />
                    <div class="card-body">
                        <h5 class="card-title">Warehouse</h5>
                        <div class="btn-center">
                            <button type="button" class="btn btn-primary custom-btn">
                                <a href="Warehouse">Selengkapnya</a>
                            </button>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12 col-md-6 col-lg-4 d-flex justify-content-center mb-4">
                <div class="card rounded-img shadow-card" style="width: 20rem">
                    <img src="images/animal.webp" class="card-img-top rounded-img" alt="BenchScale" />
                    <div class="card-body">
                        <h5 class="card-title">Algiculture & Animal Scale</h5>
                        <div class="btn-center">
                            <button type="button" class="btn btn-primary custom-btn">
                                <a href="Algiculture_Animal_Scale">Selengkapnya</a>
                            </button>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12 col-md-6 col-lg-4 d-flex justify-content-center mb-4">
                <div class="card rounded-img shadow-card" style="width: 20rem">
                    <img src="images/fishery.webp" class="card-img-top rounded-img" alt="BenchScale" />
                    <div class="card-body">
                        <h5 class="card-title">Fishery</h5>
                        <div class="btn-center">
                            <button type="button" class="btn btn-primary custom-btn">
                                <a href="Fishery">Selengkapnya</a>
                            </button>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12 col-md-6 col-lg-4 d-flex justify-content-center mb-4">
                <div class="card rounded-img shadow-card" style="width: 20rem">
                    <img src="images/seaport.webp" class="card-img-top rounded-img" alt="BenchScale" />
                    <div class="card-body">
                        <h5 class="card-title">Seaport</h5>
                        <div class="btn-center">
                            <button type="button" class="btn btn-primary custom-btn">
                                <a href="Seaport">Selengkapnya</a>
                            </button>
                        </div>
                    </div>
                </div>
